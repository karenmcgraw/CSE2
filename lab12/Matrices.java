...
public class Matrices{
    ...
    public static void main(String[] args){
        ...
        int[][]AB=addMatrix(matrixA,true,matrixB,false);
        System.out.println("Adding two marices");
        printMatrix(AB,true);
        int[][]AC=addMatrix(matrixA,true,matrixC,true);
        if(AC!=null){
            printMatrix(AC,true);
        }    
    }
    ...
    public static int[][] addMatrix(int[][]a, boolean formata, int[][]b, boolean formatb){
       ...
       if(height1!=height2||width1!=width2){
           System.out.println("arrays can't be added");
           return null;
       }
